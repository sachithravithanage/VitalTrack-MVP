...
class PlateletsHistoryScreen extends StatelessWidget {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              // Custom Pill Icon Container
              Container(
                width: 50,
                height: 50,
                decoration: BoxDecoration(
                  color:
                      isLow ? const Color(0xFFFEF2F2) : const Color(0xFFF0FDF4),
                  borderRadius: BorderRadius.circular(16),
                ),
                child: Center(
                  child: Transform.rotate(
                    angle: -0.5, // Slight tilt to match your UI
                    child: Container(
                      width: 20,
                      height: 10,
                      decoration: BoxDecoration(
...
class PlateletsChartPainter extends CustomPainter {
  final Color lineColor;
  final Color fillColor;

  PlateletsChartPainter({required this.lineColor, required this.fillColor});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Adjusted coordinates specifically for the Platelets trend (starts low, drops, spikes, drops)
    final points = [
      Offset(0, size.height * 0.7),
      Offset(size.width * 0.16, size.height * 0.65),
      Offset(size.width * 0.33, size.height * 0.6),
      Offset(size.width * 0.45, size.height * 0.75), // The dip
      Offset(size.width * 0.6, size.height * 0.2), // The spike
