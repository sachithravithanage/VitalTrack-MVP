...
class _PrivacySecurityScreenState extends State<PrivacySecurityScreen> {
  ...
  // Fetch their current 2FA preference from the database
  ...
  // Securely update the 2FA toggle in the database
  Future<void> _toggle2FA(bool value) async {
    ...
    if (user != null) {
      try {
        ...
        setState(() => _is2FAEnabled = !value); // Revert toggle on failure
        if (!mounted) return;
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
          ...
          : ListView(
              ...
              children: [
                ...
                _buildActionTile(
                  ...
                  onTap: () => _toggle2FA(
                      !_is2FAEnabled), // Allows tapping the whole row
                  trailing: Switch(
                    value: _is2FAEnabled,
                    activeThumbColor: const Color(0xFF20B5A0),
