...
class _UrineOutputHistoryScreenState extends State<UrineOutputHistoryScreen> {
  ...
  List<double> _getTrendData() {
    ...
    if (globalUrineHistory.isNotEmpty) {
      var recentRecords = globalUrineHistory.take(7).toList().reversed.toList();
  ...
  Widget build(BuildContext context) {
    final latestRecord = globalUrineHistory.isNotEmpty
        ...
        child: Column(
          ...
          children: [
            ...
            if (globalUrineHistory.isEmpty)
              ...
              ...globalUrineHistory.map((record) => _buildDailyLogItem(record)),
          ],
        ),
      ),
    );
