...
class AppState extends ChangeNotifier {
  ...
  Future<Map<String, dynamic>> sendStepUpOtp({
    ...
    return authService.sendStepUpOtp(purpose: purpose, channel: channel);
  }
  ...
  Future<void> syncStoredFcmToken() async {
    if (currentUser == null) return;

    final String? token = storageService.getFCMToken();
    ...
    try {
      ...
      debugPrint('Sync FCM token error: $e');
    }
  }
}
